<template>
  <div
    class="relative w-full h-full rounded-2xl cursor-pointer transition-all duration-75 ease-in active:scale-[0.98]"
  >
    <div
      class="h-full w-full backdrop-blur-md rounded-2xl overflow-hidden bg-stone-200/10 shadow-xl"
    ></div>
    ...
    <div
      class="absolute h-full w-full top-0 left-0 right-0 bottom-0 rounded-2xl overflow-hidden bg-indigo-300/10"
