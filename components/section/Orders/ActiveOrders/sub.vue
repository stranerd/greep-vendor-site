<template>
  ...
  <template v-if="marketplaceLoadingStates.allOrders !== API_STATES.LOADING">
    <!-- <div class="grids my-4 w-full grid-cols-3 gap-4 lg:w-[96%]">
      <div class="my-2 grid w-full gap-4 bg-red-500">
        <div
          ...
          <div class="flex gap-4 overflow-x-auto">
            ...
            >
              ...
              <div class="flex w-full items-center gap-x-5">
                ...
                <div class="w-fit">
                  <Skeleton
                    class="my-3 h-4 w-[200px] rounded-lg"
                    v-for="i in 2"
                  />
                </div>
              </div>
    ...
    <div
    class="grids my-2 hidden w-[96%] grid-cols-3 gap-4"
    v-if="marketplaceLoadingStates.allOrders === API_STATES.SUCCESS"
  >
    ...
    const marketOrders = computed(() => {
      return [
        ...
        },
        {
          ...
          message:
            "No current orders, accept orders or check back for new order!",
          orders: orders.value.filter(
        ...
        },
        {
          ...
          message:
            "No shipped orders, ship orders or check back for new order!",
          orders: orders.value.filter(
